...
// import { InteractionPointerEvent, TouchInteractionEvent } from "../types.js";
...
// 		canvas.stage.on("touchstart", (event: InteractionPointerEvent) => this.onEvent(event, this.onTouchStart.bind(this)));
// 		canvas.stage.on("touchmove", (event: InteractionPointerEvent) => this.onEvent(event, this.onTouchMove.bind(this)));
// 		canvas.stage.on("touchend", (event: InteractionPointerEvent) => this.onEvent(event, this.onTouchEnd.bind(this)));
// 		canvas.stage.on("touchcancel", (event: InteractionPointerEvent) => this.onEvent(event, this.onTouchCancel.bind(this)));
// 		canvas.stage.on("tap", (event: InteractionPointerEvent) => this.onEvent(event, this.onOneFingerTap.bind(this)));
//
...
// 	}
//
// 	onEvent(event: InteractionPointerEvent, next: (event: InteractionPointerEvent) => void) {
// 		if (event.type === "click") {
