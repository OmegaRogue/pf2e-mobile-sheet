...
export { actionTraits, ancestryTraits, armorTraits, backgroundTraits, classTraits, consumableTraits, creatureTraits, damageTraits, elementTraits, energyDamageTypes, equipmentTraits, featTraits, hazardTraits, kingmakerTraits, magicTraditions, npcAttackTraits, otherArmorTags, otherConsumableTags, otherWeaponTags, preciousMaterials, spellTraits, traitDescriptions, vehicleTraits, weaponTraits, type ElementTrait, };
