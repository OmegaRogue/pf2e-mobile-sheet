...
declare const ITEM_ALTERATION_VALIDATORS: {
	"ac-bonus": ItemAlterationValidator<{
		...
		mode: StringField<
			"upgrade" | "override" | "downgrade" | "add" | "remove" | "subtract",
			"upgrade" | "override" | "downgrade" | "add" | "remove" | "multiply" | "subtract",
			true,
			false,
			false
		>;
	...
	"persistent-damage": ItemAlterationValidator<{
		...
		mode: StringField<
			...
			false
		>;
		value: import("types/foundry/common/data/fields.d.ts").SchemaField<
