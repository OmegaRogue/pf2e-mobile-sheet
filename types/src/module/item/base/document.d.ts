...
declare class ItemPF2e<TParent extends ActorPF2e | null = ActorPF2e | null> extends Item<TParent> {
	...
	refreshFromCompendium(options?: { name?: boolean; notify?: boolean }): Promise<void>;
	 ...
	 */
	protected processChatData<T extends ItemSummaryData>(
	...
	protected traitChatData(
		...
		traits?: import("./data/system.ts").ItemTrait[],
	): TraitChatData[];
	...
	static createDocuments<TDocument extends foundry.abstract.Document>(
		this: ConstructorOf<TDocument>,
		data?: (TDocument | PreCreate<TDocument["_source"]>)[],
		context?: DocumentModificationContext<TDocument["parent"]>,
	): Promise<TDocument[]>;
	static deleteDocuments<TDocument extends foundry.abstract.Document>(
		this: ConstructorOf<TDocument>,
		ids?: string[],
		context?: DocumentModificationContext<TDocument["parent"]>,
	): Promise<TDocument[]>;
