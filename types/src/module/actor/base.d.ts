...
declare class ActorPF2e<TParent extends TokenDocumentPF2e | null = TokenDocumentPF2e | null> extends Actor<TParent> {
	...
	static updateDocuments<TDocument extends foundry.abstract.Document>(
		this: ConstructorOf<TDocument>,
	...
	getCheckContext<TStatistic extends StatisticCheck | StrikeData, TItem extends ItemPF2e<ActorPF2e> | null>(
