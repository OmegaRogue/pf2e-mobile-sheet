...
declare const KINGDOM_SCHEMA: {
	...
	>;
	name: StringField<string, string, true, false, true>;
	img: import("types/foundry/common/data/fields.d.ts").FilePathField<
		| `${string}.apng`
		| `${string}.avif`
		| `${string}.bmp`
		| `${string}.gif`
	...
	xp: SchemaField<
		{
			value: import("types/foundry/common/data/fields.d.ts").NumberField<
				number,
				unknown,
				boolean,
				boolean,
				boolean
			>;
			max: import("types/foundry/common/data/fields.d.ts").NumberField<
				number,
				unknown,
				boolean,
				boolean,
			...
			SchemaField<
				{
					value: import("types/foundry/common/data/fields.d.ts").NumberField<
						...
						true
					>;
					mod: import("types/foundry/common/data/fields.d.ts").NumberField<
						number,
						number,
						false,
						false,
					...
					ruin: SchemaField<
						...
						boolean
					>;
					penalty: import("types/foundry/common/data/fields.d.ts").NumberField<
						number,
						number,
						false,
						false,
	...
	build: SchemaField<
		{
			...
			skills: SchemaField<
				Record<
					...
					SchemaField<
						{
							rank: import("types/foundry/common/data/fields.d.ts").NumberField<
								ZeroToFour,
								ZeroToFour,
								true,
								false,
			...
			boosts: SchemaField<
				Record<
					"1" | "5" | "10" | "15" | "20" | "charter" | "heartland" | "government",
					ArrayField<
						StringField<
							"culture" | "economy" | "loyalty" | "stability",
							"culture" | "economy" | "loyalty" | "stability",
		...
		true
	>;
	customModifiers: import("types/foundry/common/data/fields.d.ts").ObjectField<
		Record<string, RawModifier[]>,
		Record<string, RawModifier[]>,
		true,
		false,
		true
	>;
	leadership: SchemaField<
		Record<
			"general" | "ruler" | "counselor" | "emissary" | "magister" | "treasurer" | "viceroy" | "warden",
			SchemaField<
				{
					uuid: StringField<string, string, false, true, true>;
					vacant: import("types/foundry/common/data/fields.d.ts").BooleanField<
						boolean,
						boolean,
						true,
						false,
						true
					>;
					invested: import("types/foundry/common/data/fields.d.ts").BooleanField<
						boolean,
						boolean,
						false,
						false,
	...
	resources: SchemaField<
		{
			dice: SchemaField<
				{
					number: import("types/foundry/common/data/fields.d.ts").NumberField<
						number,
						number,
						false,
						true,
						true
					>;
					faces: import("types/foundry/common/data/fields.d.ts").NumberField<
						number,
						number,
						false,
						true,
						true
					>;
					bonus: import("types/foundry/common/data/fields.d.ts").NumberField<
						number,
						number,
						true,
						false,
			...
			fame: SchemaField<
				...
				true
			>;
			commodities: SchemaField<
				Record<
					"stone" | "food" | "luxuries" | "lumber" | "ore",
					SchemaField<
						{
							value: import("types/foundry/common/data/fields.d.ts").NumberField<
								number,
					...
					SchemaField<
						{
							...
							resource: import("types/foundry/common/data/fields.d.ts").NumberField<
								number,
								number,
								false,
								false,
		...
		SchemaField<
			{
				...
				>;
				level: import("types/foundry/common/data/fields.d.ts").NumberField<1, 1, false, false, true>;
				overcrowded: import("types/foundry/common/data/fields.d.ts").BooleanField<
					boolean,
					boolean,
					true,
					false,
				...
				consumption: SchemaField<
					{
						base: import("types/foundry/common/data/fields.d.ts").NumberField<
							number,
							number,
							false,
							false,
						...
						>;
						/** Some settlements reduce consumption, this is the number of reductions that may exist */
						reduction: import("types/foundry/common/data/fields.d.ts").NumberField<
							number,
							number,
							false,
							false,
							true
						>;
						total: import("types/foundry/common/data/fields.d.ts").NumberField<
							number,
							number,
							false,
							false,
				...
				storage: SchemaField<
					Record<
						string,
						import("types/foundry/common/data/fields.d.ts").NumberField<number, number, false, false, true>
					>,
					SourceFromSchema<
						Record<
							string,
							import("types/foundry/common/data/fields.d.ts").NumberField<
								number,
								number,
								false,
								false,
	...
	unrest: SchemaField<
		{
			value: import("types/foundry/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
			anarchyThreshold: import("types/foundry/common/data/fields.d.ts").NumberField<
				number,
				number,
				false,
				false,
