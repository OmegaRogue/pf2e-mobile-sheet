...
import type { ArrayField, SchemaField, StringField } from "foundry-types/common/data/fields.d.ts";
...
declare const KINGDOM_SETTLEMENT_SCHEMA: {
	...
	level: import("foundry-types/common/data/fields.d.ts").NumberField<1, 1, false, false, true>;
	overcrowded: import("foundry-types/common/data/fields.d.ts").BooleanField<boolean, boolean, true, false, true>;
    description: StringField<string, string, false, false, true>;
	sort: import("foundry-types/common/data/fields.d.ts").IntegerSortField<true, false, true>;
    consumption: SchemaField<{
	    base: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
        /** Some settlements reduce consumption, this is the number of reductions that may exist */
        reduction: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
	    total: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
    }, SourceFromSchema<{
	    base: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
        /** Some settlements reduce consumption, this is the number of reductions that may exist */
        reduction: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
	...
	storage: SchemaField<Record<string, import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>>, SourceFromSchema<Record<string, import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>>>, ModelPropsFromSchema<Record<string, import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>>>, true, false, true>;
};
declare const KINGDOM_SCHEMA: {
    ...
    name: StringField<string, string, true, false, true>;
	img: import("foundry-types/common/data/fields.d.ts").FilePathField<`${string}.apng` | `${string}.avif` | `${string}.bmp` | `${string}.gif` | `${string}.jpeg` | `${string}.jpg` | `${string}.png` | `${string}.svg` | `${string}.tiff` | `${string}.webp`, `${string}.apng` | `${string}.avif` | `${string}.bmp` | `${string}.gif` | `${string}.jpeg` | `${string}.jpg` | `${string}.png` | `${string}.svg` | `${string}.tiff` | `${string}.webp`, true, false, true>;
    capital: StringField<"", "", true, false, true>;
	size: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, true, false, true>;
	level: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, true, false, true>;
    xp: SchemaField<{
	    value: import("foundry-types/common/data/fields.d.ts").NumberField<number, unknown, boolean, boolean, boolean>;
	    max: import("foundry-types/common/data/fields.d.ts").NumberField<number, unknown, boolean, boolean, boolean>;
    }, SourceFromSchema<{
	    value: import("foundry-types/common/data/fields.d.ts").NumberField<number, unknown, boolean, boolean, boolean>;
	    max: import("foundry-types/common/data/fields.d.ts").NumberField<number, unknown, boolean, boolean, boolean>;
    }>, ModelPropsFromSchema<{
    ...
    abilities: SchemaField<Record<"culture" | "economy" | "loyalty" | "stability", SchemaField<{
	    value: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
	    mod: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
        ruin: SchemaField<{
	        value: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, true, false, true>;
	        max: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, true, false, true>;
        }, SourceFromSchema<{
	        value: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, true, false, true>;
	        max: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, true, false, true>;
        }>, unknown, boolean, boolean, boolean>;
	    penalty: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
    }, SourceFromSchema<{
	    value: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
	    mod: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
        ruin: SchemaField<{
    ...
    build: SchemaField<{
        ...
        manual: import("foundry-types/common/data/fields.d.ts").BooleanField<boolean, boolean, true, false, true>;
        charter: SchemaField<{
        ...
        skills: SchemaField<Record<"magic" | "exploration" | "defense" | "agriculture" | "arts" | "boating" | "engineering" | "folklore" | "industry" | "intrigue" | "politics" | "scholarship" | "statecraft" | "trade" | "warfare" | "wilderness", SchemaField<{
	        rank: import("foundry-types/common/data/fields.d.ts").NumberField<ZeroToFour, ZeroToFour, true, false, true>;
        }, SourceFromSchema<{
	        rank: import("foundry-types/common/data/fields.d.ts").NumberField<ZeroToFour, ZeroToFour, true, false, true>;
        }>, ModelPropsFromSchema<{
	        rank: import("foundry-types/common/data/fields.d.ts").NumberField<ZeroToFour, ZeroToFour, true, false, true>;
	...
	customModifiers: import("foundry-types/common/data/fields.d.ts").ObjectField<Record<string, RawModifier[]>, Record<string, RawModifier[]>, true, false, true>;
    leadership: SchemaField<Record<"general" | "ruler" | "counselor" | "emissary" | "magister" | "treasurer" | "viceroy" | "warden", SchemaField<{
	    ...
	    vacant: import("foundry-types/common/data/fields.d.ts").BooleanField<boolean, boolean, true, false, true>;
	    invested: import("foundry-types/common/data/fields.d.ts").BooleanField<boolean, boolean, false, false, true>;
    }, SourceFromSchema<{
        uuid: StringField<string, string, false, true, true>;
	    vacant: import("foundry-types/common/data/fields.d.ts").BooleanField<boolean, boolean, true, false, true>;
	    invested: import("foundry-types/common/data/fields.d.ts").BooleanField<boolean, boolean, false, false, true>;
    ...
    resources: SchemaField<{
        dice: SchemaField<{
	        number: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, true, true>;
	        faces: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, true, true>;
	        bonus: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, true, false, true>;
	        penalty: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, true, false, true>;
        }, SourceFromSchema<{
	        number: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, true, true>;
	        faces: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, true, true>;
	        bonus: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, true, false, true>;
	    ...
	    points: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
        ...
        workSites: SchemaField<Record<string, SchemaField<{
            ...
            resource: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
        }, SourceFromSchema<{
            /** The number of regular non-resource work sites */
            value: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
            /** The number of worksites that are on resource hexes (these grant double) */
    ...
    consumption: SchemaField<{
	    settlement: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
	    army: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
	    value: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
    ...
    unrest: SchemaField<{
	    value: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
	    anarchyThreshold: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
    }, SourceFromSchema<{
	    value: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
	    anarchyThreshold: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
    }>, ModelPropsFromSchema<{
    ...
    event: SchemaField<{
	    dc: import("foundry-types/common/data/fields.d.ts").NumberField<number, number, false, false, true>;
    ...
    module: import("foundry-types/common/data/fields.d.ts").ObjectField<{}, {}, false, false, true>;
};
